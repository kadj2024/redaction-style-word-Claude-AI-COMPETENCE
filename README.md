...
- `SKILL.md` — instructions et règles de la compétence
- `redaction-style-word-avance.mddoit` — métadonnées de la compétence
...
```bash
git clone https://github.com/kadj2024/redaction-style-word.git
